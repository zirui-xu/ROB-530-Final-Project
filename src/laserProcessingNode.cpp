    ...
    while(1){
        if(!pointCloudBuf.empty()){
            ...
            *pointcloud_filtered+=*pointcloud_surf;
            ...
            laserCloudFilteredMsg.header.frame_id = "/camera_init"; // base_link
            ...
            edgePointsMsg.header.frame_id = "/camera_init"; // base_link
            ...
            surfPointsMsg.header.frame_id = "/camera_init"; // base_link
